...
class TourRouteRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'points.*.intro_video_paths' => ['nullable', 'array'],
            'points.*.intro_video_paths.en' => ['nullable', 'string'],
            'points.*.intro_video_paths.id' => ['nullable', 'string'],
            'points.*.intro_video_tmp' => ['nullable', 'array'],
            'points.*.intro_video_tmp.en' => ['nullable', 'string'],
            'points.*.intro_video_tmp.id' => ['nullable', 'string'],
            'points.*.intro_audio_paths' => ['nullable', 'array'],
            'points.*.intro_audio_paths.en' => ['nullable', 'string'],
