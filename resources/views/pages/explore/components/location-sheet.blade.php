    ...
    <div
        ...
        <div class="mb-4 flex items-start justify-between">
            <div>
                ...
                <span id="sheet-category-badge" class="inline-flex items-center gap-1.5 mt-2 rounded-full border px-2.5 py-0.5 text-[10px] font-bold uppercase tracking-wider">
        ...
        <div class="max-h-[30dvh] overflow-y-auto space-y-4 pr-1">
            ...
            <div id="section-accessibility" class="rounded-2xl bg-amber-50/80 border border-amber-100/60 p-4 flex gap-3">
