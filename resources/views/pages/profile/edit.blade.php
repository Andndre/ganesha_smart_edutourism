...
@section('content')
    <div class="px-5 py-6">
        ...
        <form action="{{ route('profile.update') }}" method="POST" class="space-y-5">
            ...
            <div>
                <label for="preferred_language" class="block text-sm font-bold text-charcoal mb-1.5">Bahasa Pilihan
                    (Opsional)</label>
                <div class="relative">
            ...
            <div class="mb-2">
                <h3 class="text-lg font-bold text-charcoal mb-1" style="font-family: 'Playfair Display', serif;">Ubah Kata
                    Sandi</h3>
            ...
            <!-- New Password Field -->
            <div>
                <label for="password" class="block text-sm font-bold text-charcoal mb-1.5">Kata Sandi Baru
                    (Opsional)</label>
            ...
            <div>
                <label for="password_confirmation" class="block text-sm font-bold text-charcoal mb-1.5">Konfirmasi Kata
                    Sandi Baru</label>
