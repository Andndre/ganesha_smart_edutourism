...
<div class="relative pb-32">
    ...
    <div class="px-4 py-4 bg-white mt-2 border-y border-gray-100 flex items-center justify-between">
        ...
        <button class="px-4 py-1.5 border border-primary text-primary text-sm font-medium rounded-full">Kunjungi</button>
    </div>
    ...
    <div class="px-4 py-6 bg-white mt-2 border-t border-gray-100">
        ...
        <p class="text-sm text-gray-600 leading-relaxed">
            Kopi Luwak khas Desa Wisata Penglipuran, diproses secara tradisional menggunakan metode sangrai manual. Menghasilkan aroma kopi yang kuat dengan tingkat keasaman rendah yang nyaman di lambung. Biji kopi dipilih dari perkebunan lokal Bali yang terjaga kualitasnya.
        </p>
...
<div class="fixed bottom-[calc(env(safe-area-inset-bottom)+3.5rem)] inset-x-0 p-4 bg-white border-t border-gray-100 z-30 shadow-[0_-4px_10px_rgba(0,0,0,0.05)]">
    <div class="flex items-center gap-3">
        ...
        <button class="flex-1 bg-primary text-white font-bold h-12 rounded-xl active:scale-[0.98] transition-all" onclick="if(navigator.vibrate) navigator.vibrate(50)">
            Beli Sekarang
        </button>
    </div>
</div>
