...
@section('content')
    <article class="bg-surface pb-10">
        ...
        <div class="w-full h-[40dvh] bg-gray-200 relative overflow-hidden">
            ...
            <div class="absolute inset-0 bg-linear-to-t from-charcoal/90 via-charcoal/20 to-transparent"></div>
        ...
        <div
            ...
            <p class="text-lg font-medium text-charcoal leading-relaxed mb-6">
                Bagi masyarakat Desa Penglipuran, ruang tidak sekadar tempat bernaung, melainkan kosmos yang harus dijaga
                keseimbangannya.
            </p>

            <p>
                Konsep <strong>Tri Hita Karana</strong>—tiga harmoni antara manusia dengan Tuhan, manusia dengan alam, dan
                manusia dengan sesamanya—menjelma paling nyata di Pura Penataran ini. Terletak di area "Utama Mandala" atau
                bagian paling utara dan tertinggi dari desa, pura ini adalah pusat dari segala kegiatan ritual.
            </p>

            <h2>Arsitektur Bambu Kuno</h2>
            <p>
                Ciri khas utama pura ini adalah penggunaan atap bambu tradisional. Berbeda dengan sirap kayu, penggunaan
                bambu yang dipanen langsung dari Hutan Bambu sakral desa menunjukkan penghormatan mendalam terhadap material
                lokal yang disediakan alam.
            </p>

            <div class="bg-gray-50 border-l-4 border-accent p-4 my-6 rounded-r-lg">
                <p class="text-sm text-charcoal font-medium m-0 italic">"Alam memberi kehidupan, maka pantaslah kita
                    memberikan penghormatan kembali melalui apa yang kita bangun."</p>
            </div>

            <h2>Pantangan & Etika</h2>
            <p>
                Wisatawan diperbolehkan melihat dari pelataran luar, namun memasuki area suci harus mematuhi aturan ketat,
                seperti memakai kain adat (kamben) dan selendang, serta dilarang masuk bagi wanita yang sedang dalam masa
                menstruasi.
            </p>
        </div>
