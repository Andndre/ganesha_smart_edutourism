    ...
    <div class="px-4 pb-24 pt-[calc(env(safe-area-inset-top)+6rem)]">
        ...
        @if($visitedItems->isEmpty())
            <div class="flex flex-col items-center justify-center text-center h-[60vh]">
                ...
                <h2 class="text-xl font-bold text-charcoal mb-2">{{ __('Belum Ada Kunjungan') }}</h2>
                <p class="text-sm text-gray-500 mb-6 max-w-xs">{{ __('Mulai jelajahi rute Edutourism untuk mencatat kunjungan Anda!') }}</p>
                        ...
                        <div class="p-4">
                            <div class="flex items-start justify-between gap-2">
                                ...
                                <button onclick="toggleFavorite('{{ get_class($item) }}', {{ $item->id }}, this)"
                                    ...
                                    aria-label="{{ $isFavorited ? __('Hapus dari favorit') : __('Tambah ke favorit') }}">
