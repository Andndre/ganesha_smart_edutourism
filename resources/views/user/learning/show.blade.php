...
@section('content')
    <div class="fixed inset-0 z-50 bg-[#FAF9F6] flex flex-col" id="quiz-container">
        ...
        <div
            class="pt-sat px-5 py-4 flex items-center gap-4 bg-white/80 backdrop-blur-md border-b border-gray-100 shadow-sm z-10">
        ...
        <div class="flex-1 overflow-y-auto px-5 py-8">
            ...
            <div class="space-y-4" id="options-container">
                <!-- Option 1 -->
                <button
                    class="quiz-option w-full text-left p-5 rounded-2xl border-2 border-gray-200 bg-white text-gray-700 font-bold border-b-[6px] active:border-b-2 active:translate-y-1 transition-all flex items-center justify-between group">
                    <span class="text-lg">Sirap Kayu Ulin</span>
                    <div
                        class="radio-circle w-6 h-6 rounded-full border-2 border-gray-300 transition-colors flex items-center justify-center">
                    </div>
                </button>
        ...
        <div class="border-t border-gray-200 p-5 pb-sab bg-white shadow-[0_-10px_20px_rgba(0,0,0,0.03)]">
            <button id="check-btn"
                class="w-full bg-gray-200 text-gray-400 py-4 rounded-2xl font-bold text-lg border-b-[6px] border-gray-300 transition-all pointer-events-none"
                disabled>
                CEK JAWABAN
            </button>
        </div>
