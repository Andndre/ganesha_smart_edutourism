...
<form method="GET" action="{{ route('umkm') }}" class="relative mb-6">
    ...
    <input type="search" name="q" value="{{ $q ?? '' }}"
        class="focus:border-primary focus:ring-primary/20 w-full rounded-xl border border-gray-200 bg-white px-5 py-3.5 pl-12 pr-24 text-sm shadow-sm transition-all placeholder:text-gray-500 focus:outline-none focus:ring-2"
