...
<div
    class="fixed bottom-[calc(env(safe-area-inset-bottom)+4rem+var(--route-banner-h,0px))] left-0 right-0 z-40 border-t border-gray-200 bg-white/80 px-4 pb-8 pt-4 backdrop-blur-md transition-all md:absolute md:bottom-0 md:pb-4">
