            ...
            <div
                ...
                @if(app()->getLocale() === 'en')
                    ...
                    <div class="p-4 rounded-2xl bg-primary/5 border border-primary/10 text-primary text-xs">
                        <strong>Privacy First:</strong> Your privacy is extremely important to us. Ganesha Smart Edutourism is
                    ...
                    <div class="space-y-4">
                        <section
                            ...
                            <h3
                                ...
                                <svg class="h-5 w-5 text-primary/70 shrink-0" fill="none" viewBox="0 0 24 24"
                            ...
                            <p class="mt-2 pl-7 text-gray-500">
                                ...
                                achievements. When using map directions or AR scanning, the app utilizes your camera feed and
                        ...
                        <section
                            ...
                            <p class="mt-2 pl-7 text-gray-500">
                                ...
                                encryption. Passwords are hash-encrypted locally in our database using standard industry-grade
                                cryptography (bcrypt).
                            </p>
                        </section>
                        ...
                        <section
                            ...
                            <p class="mt-2 pl-7 text-gray-500">
                                Payment gateways process transactional tasks independently. We do not store credit card details
                        ...
                        <section
                            ...
                            <p class="mt-2 pl-7 text-gray-500">
                                You hold total control over your personal profile data. You can access, edit, or terminate your
                                profile registration details at any time from your profile dashboard settings. Camera
                                permissions for AR can be toggled on or off directly through your browser or device settings.
                            </p>
                        </section>
                    </div>
                ...
                @else
                    ...
                    <div class="p-4 rounded-2xl bg-primary/5 border border-primary/10 text-primary text-xs">
                        <strong>Mengutamakan Privasi:</strong> Privasi Anda sangat penting bagi kami. Ganesha Smart Edutourism
                    ...
                    <div class="space-y-4">
                        <section
                            ...
                            <p class="mt-2 pl-7 text-gray-500">
                                Kami mengumpulkan informasi akun dasar (nama, alamat email) untuk mengelola e-ticket dan riwayat
                                pembelajaran budaya Anda. Ketika Anda menggunakan pemetaan luring atau pemindaian AR, aplikasi
                                menggunakan kamera perangkat dan koordinat GPS secara langsung. Bingkai kamera hanya diproses
                        ...
                        <section
                            ...
                            <p class="mt-2 pl-7 text-gray-500">
                                Data akun dan alur transaksi Anda dilindungi dengan enkripsi Secure Sockets Layer (SSL). Semua
                        ...
                        <section
                            ...
                            <p class="mt-2 pl-7 text-gray-500">
                                ...
                                tidak menyimpan data nomor kartu kredit atau detail otentikasi perbankan Anda di server kami.
                            </p>
                        </section>
                        ...
                        <section
                            ...
                            <p class="mt-2 pl-7 text-gray-500">
                                Anda memiliki kontrol penuh atas data profil Anda. Anda berhak melihat, mengedit, atau menghapus
