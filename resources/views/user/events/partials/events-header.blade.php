...
<div class="bg-linear-to-tr from-primary relative overflow-hidden rounded-3xl to-[#2a6836] p-6 text-white shadow-xl">
    ...
    <div class="relative z-10">
        <span
            class="inline-block rounded-full bg-white/20 px-3 py-1 text-[11px] font-bold uppercase tracking-wider backdrop-blur-md">{{ __('Budaya & Event') }}</span>
