...
<div x-show="viewMode === 'list'" x-transition:enter="transition ease-out duration-300"
    ...
    <div class="flex items-center justify-between border-b border-gray-100 pb-2">
        ...
        <span class="rounded-lg bg-gray-50 px-2 py-1 text-[11px] font-bold uppercase text-gray-500"
                ...
                <div
                    ...
                    <div class="mb-3 flex flex-wrap items-center justify-between gap-2">
                        <span
                            ...
                            class="rounded-lg border px-2 py-0.5 text-[11px] font-extrabold uppercase tracking-wider"
                            x-text="e.category"></span>

                        <span :class="e.is_free ? 'bg-green-50 text-green-600' : 'bg-gray-50 text-gray-600'"
                            class="rounded-md px-2 py-0.5 text-[11px] font-extrabold uppercase tracking-wider"
                    ...
                    <div
                        ...
                        <div class="flex items-center gap-1.5">
                            <svg class="h-3.5 w-3.5 shrink-0 text-gray-500" fill="none" viewBox="0 0 24 24"
                    ...
                    <div class="mt-4 flex gap-2">
                        ...
                        <template x-if="e.latitude && e.longitude">
                            <a :href="'https://www.google.com/maps/search/?api=1&query=' + e.latitude + ',' + e.longitude"
                                target="_blank"
                                class="flex aspect-square items-center justify-center rounded-xl bg-gray-50 p-2 text-gray-500 transition-all duration-300 hover:bg-amber-50 hover:text-amber-600">
    ...
    <div x-show="filteredTimelineEvents.length === 0"
        ...
        <div class="mx-auto flex h-12 w-12 items-center justify-center rounded-full bg-gray-50 text-gray-500">
        ...
        <p class="mt-1 text-xs text-gray-500">{{ __('Tidak ada event untuk kategori yang dipilih di bulan ini.') }}</p>
    </div>
</div>
