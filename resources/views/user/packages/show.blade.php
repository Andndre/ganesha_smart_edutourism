...
@section('content')
        ...
        <div class="mx-auto w-full max-w-5xl lg:px-8 lg:py-8">
            <div class="lg:grid lg:grid-cols-2 lg:items-start lg:gap-8">
                ...
                <div
                    ...
                    <div class="mb-2">
                        <span
                            class="text-primary mb-3 inline-block rounded-lg border border-green-100 bg-green-50 px-2.5 py-1 text-xs font-bold">{{ __('Paket Wisata') }}</span>
            ...
            <div class="mb-3 grid grid-cols-3 gap-2">
                <div class="flex flex-col items-center rounded-xl border border-gray-100 bg-gray-50 py-2.5">
                    ...
                    <span class="text-charcoal text-sm font-bold">{{ $package->duration_hours }} {{ __('Jam') }}</span>
                </div>
                <div class="flex flex-col items-center rounded-xl border border-gray-100 bg-gray-50 py-2.5">
                    <svg class="text-primary mb-1 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <span class="text-charcoal text-sm font-bold">{{ $package->min_capacity }} {{ __('Orang') }}</span>
                </div>
                <div class="flex flex-col items-center rounded-xl border border-gray-100 bg-gray-50 py-2.5">
                    <svg class="text-primary mb-1 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <span class="text-charcoal text-sm font-bold">{{ $package->max_capacity }} {{ __('Orang') }}</span>
                </div>
            </div>
    ...
    <div
        ...
        <div class="mx-auto w-full max-w-2xl">
            ...
            @guest
                <p class="mt-2 text-center text-xs text-gray-400">{{ __('Anda akan diminta untuk login terlebih dahulu.') }}</p>
            @endguest
        </div>
    </div>
@endsection
