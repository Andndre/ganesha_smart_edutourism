        ...
        <div class="rounded-2xl border border-warning/20 bg-warning/5 p-6 shadow-sm max-w-3xl">
            <div class="flex items-start gap-4">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-warning-700">Akun Anda belum memiliki profil toko UMKM yang aktif. Silakan isi
                        informasi profil toko Anda terlebih dahulu agar dapat mengelola produk dan menandai lokasi di peta.</p>
                    <div class="mt-4">
