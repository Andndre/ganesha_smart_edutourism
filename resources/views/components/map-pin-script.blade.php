...
<script>
    (function() {
        ...
        const CATEGORY_GLYPHS = {
            ...
            toilets: '<circle cx="6.75" cy="3.6" r="2.1"/><rect x="4.2" y="6.9" width="5.1" height="7.6" rx="1.8"/><rect x="4.9" y="13" width="1.7" height="8" rx="0.8"/><rect x="6.9" y="13" width="1.7" height="8" rx="0.8"/><circle cx="17.25" cy="3.6" r="2.1"/><path d="M17.25 6.9 21.2 15.6H13.3z"/><rect x="15.4" y="14.6" width="1.7" height="6.4" rx="0.8"/><rect x="17.4" y="14.6" width="1.7" height="6.4" rx="0.8"/>',
        ...
        window.gseMapPin = function(category, options) {
            ...
            if (opts.number != null) {
                ...
                inner = `<g transform="translate(6 5) scale(0.75)" fill="${ink}">${glyph}</g>`;
            }
