    ...
    <div class="space-y-4">
        ...
        <div class="grid grid-cols-2 gap-3">
            <div class="rounded-2xl border border-gray-100 bg-gray-50/70 p-3.5">
                <p class="text-[9px] font-bold uppercase leading-none tracking-wider text-gray-400">Wuku</p>
                <p class="mt-1 text-xs font-black text-gray-700" x-text="selectedBalineseDate.wuku"></p>
            </div>
            <div class="rounded-2xl border border-gray-100 bg-gray-50/70 p-3.5">
                <p class="text-[9px] font-bold uppercase leading-none tracking-wider text-gray-400">Sasih</p>
                <p class="mt-1 text-xs font-black text-gray-700" x-text="selectedBalineseDate.sasih"></p>
            </div>
            <div class="rounded-2xl border border-gray-100 bg-gray-50/70 p-3.5">
                <p class="text-[9px] font-bold uppercase leading-none tracking-wider text-gray-400">Wewaran</p>
                <p class="mt-1 text-xs font-black text-gray-700"
                    x-text="selectedBalineseDate.pancaWara + ' ' + selectedBalineseDate.saptaWara"></p>
            </div>
            <div class="rounded-2xl border border-gray-100 bg-gray-50/70 p-3.5">
                <p class="text-[9px] font-bold uppercase leading-none tracking-wider text-gray-400">Saka</p>
        ...
        <template
            ...
            <div class="border-t border-gray-50 pt-3">
                <h4 class="mb-1.5 text-[10px] font-black uppercase tracking-wider text-gray-400">Rerainan</h4>
