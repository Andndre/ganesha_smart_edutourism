{{-- All Rahinan / hari penting in the currently viewed month --}}
<x-modal name="balinese-month-list-modal" maxWidth="md">
    <div class="space-y-4">
        <h3 class="font-display text-charcoal text-xl font-bold">
            Hari Raya <span x-text="monthRahinanLabel"></span>
        </h3>

        <template x-if="monthRahinanList.length === 0">
            <p class="text-xs text-gray-500">Tidak ada rerainan tercatat bulan ini.</p>
        </template>
