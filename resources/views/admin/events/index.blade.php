...
@section('content')
    ...
    <div x-data="adminEvents" @open-event-modal.window="selectedEvent = $event.detail; showModal = true"
        ...
        <div x-show="showModal"
            class="bg-charcoal/60 fixed -inset-10 z-50 flex items-center justify-center px-4 backdrop-blur-sm"
            ...
            <div class="relative w-full max-w-lg rounded-3xl bg-white p-6 shadow-2xl" @click.away="showModal = false">
                {{-- Modal Header --}}
                ...
                <div class="mt-6 flex justify-end gap-3 border-t border-gray-100 pt-4">
                    <button type="button" @click="showModal = false; openEdit(selectedEvent.raw)"
        ...
        <div x-show="showFormModal"
            class="bg-charcoal/60 fixed -inset-10 z-50 flex items-start justify-center overflow-y-auto px-4 py-16 backdrop-blur-sm"
            style="display: none; will-change: transform; transform: translate3d(0,0,0);"
            x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 scale-95"
            x-transition:enter-end="opacity-100 scale-100" x-transition:leave="transition ease-in duration-200"
            x-transition:leave-start="opacity-100 scale-100" x-transition:leave-end="opacity-0 scale-95">
