    ...
    <form id="model-form" method="POST" action="" enctype="multipart/form-data" x-data="{ locale: 'id' }">
        ...
        <div class="space-y-4">
            ...
            <div>
                ...
                <span class="mb-1.5 block text-[11px] text-gray-500">Opsional. Harus unik. Digunakan sebagai kode
                ...
                <div id="modal-marker-preview-wrapper" class="mt-2 hidden">
                    <div
                        ...
                        <div class="flex min-w-0 flex-col gap-1.5">
                            <span class="text-[11px] text-gray-500">Pola .patt akan disimpan otomatis ke server.</span>
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div>
                    ...
                    <p id="edit-current-glb-container" class="mt-1.5 hidden text-[11px] text-gray-500">
                ...
                <div>
                    ...
                    <span class="mb-1 block text-[11px] text-gray-500">Maksimal 50MB.</span>
                    ...
                    <p id="edit-current-usdz-container" class="mt-1.5 hidden text-[11px] text-gray-500">
            ...
            <div>
                ...
                <span class="mb-2 block text-[11px] text-gray-500">Maksimal 10MB per file. Diputar otomatis di web viewer.</span>
            ...
            <div class="mt-2.5 rounded-2xl border border-dashed border-gray-200 bg-gray-50/50 p-3">
                <span class="mb-1.5 block text-[11px] font-bold uppercase tracking-wider text-gray-500">Pratinjau Aset
                    Model 3D</span>
                <div class="model-viewer-wrapper flex items-center justify-center">
                    <div id="modal-viewer-placeholder" class="p-4 text-center">
                        <span class="text-xs text-gray-500">Pilih atau unggah file GLB untuk melihat model 3D</span>
                    </div>
