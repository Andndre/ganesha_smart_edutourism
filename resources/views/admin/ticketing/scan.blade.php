        ...
        <div class="mx-auto max-w-3xl sm:px-6 lg:px-8">
            <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <h3 class="mb-4 text-center text-lg font-medium text-gray-700">Arahkan kamera ke QR Code tiket
                        pengunjung</h3>

                    <div id="reader"
                        class="mx-auto w-full max-w-lg overflow-hidden rounded-xl border-2 border-dashed border-gray-300">
                    </div>
            ...
            function onScanSuccess(decodedText, decodedResult) {
                ...
                fetch('{{ route('staff.ticketing.verify') }}', {
                    ...
                    .then(res => {
                        ...
                        resultDiv.classList.remove('hidden', 'bg-green-50', 'text-green-900', 'bg-red-50',
                            'text-red-900', 'border', 'border-green-200', 'border-red-200');

                        if (data.success) {
                            resultDiv.classList.add('bg-green-50', 'text-green-900', 'border',
                                'border-green-200');
                            resultDiv.innerHTML = `
