                    ...
                    <tr class="hover:bg-gray-50/50">
                        ...
                        <td class="px-5 py-4">
                            <div class="flex items-center gap-2">
                                ...
                                <form method="POST" action="{{ route('admin.umkm.destroy', $p->id) }}" class="delete-form inline" data-confirm="Apakah Anda yakin ingin menghapus produk ini?">
                                    @csrf
                                    @method('DELETE')
...
{{-- Product Modal Form --}}
<x-modal name="product-modal" maxWidth="xl">
    <div class="mb-4">
