                    ...
                    <tr class="hover:bg-gray-50/50">
                        ...
                        <td class="px-5 py-4">
                            <div class="flex items-center gap-2">
                                ...
                                <form method="POST" action="{{ route('admin.umkm.categories.destroy', $cat->id) }}" onsubmit="return confirm('Apakah Anda yakin ingin menghapus kategori ini? Semua produk di dalamnya akan kehilangan kategori.')" class="inline">
                                    @csrf
                                    @method('DELETE')
