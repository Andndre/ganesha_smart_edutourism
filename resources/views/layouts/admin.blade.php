        ...
        <nav class="flex-1 space-y-0.5 overflow-y-auto px-3 py-4">
            ...
            @php
                $navItems = [
                    ...
                    ['route' => 'admin.map-manager', 'icon' => 'M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z', 'label' => 'Peta Lokasi & Titik'],
                    ['route' => 'admin.umkm', 'icon' => 'M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z', 'label' => 'Produk UMKM'],
            ...
            @foreach ($navItems as $item)
                    ...
                    @endphp
                    <a href="{{ route($item['route']) }}" class="group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition-all
                                                                                                                        {{ $isActive
