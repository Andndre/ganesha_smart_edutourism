...
<body class="bg-surface text-charcoal antialiased">
                ...
                if ($isAdminPreview) {
                    ...
                    $navItems = [
                        ...
                        [
                            ...
                            'route' => 'admin.ar-manager',
                            'icon' => 'M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z',
                            'label' => 'Aset AR & Marker'
                        ],
                        [
                            'type' => 'header',
                        ...
                        [
                            'url' => route('admin.ticket-officers'),
                            'route' => 'admin.ticket-officers',
                            'icon' => 'M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z',
                            'label' => 'Petugas Tiket'
                        ],
                        [
                            'url' => route('admin.ticket-rates'),
                            'route' => 'admin.ticket-rates',
                        ...
                        [
                            'url' => route('admin.cultural-object-ratings'),
                            'route' => 'admin.cultural-object-ratings',
                            'icon' => 'M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.374 3.374 0 0014 18.469V19a2 2 0 11-4 0v-.531c0-.895-.356-1.754-.988-2.386l-.548-.547z',
                            'label' => 'Rating Objek Budaya'
                        ],
                        [
    ...
    <script src="{{ asset('js/chunked-upload.js') }}?v={{ filemtime(public_path('js/chunked-upload.js')) }}"></script>
