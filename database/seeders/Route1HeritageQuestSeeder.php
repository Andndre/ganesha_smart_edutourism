    ...
    private function rebuildMissions(array $points): void
    {
        ...
        $this->mission($points[2], 1, 'matching', ['id' => 'Heritage Explorer: Temukan Objeknya', 'en' => 'Heritage Explorer: Find the Objects'], [
            ...
            'items' => [
                ...
                ['label' => ['id' => 'Tanaman Loloh Cemcem', 'en' => 'Loloh Cemcem plant'], 'icon' => '🌿', 'correct' => true],
                ['label' => ['id' => 'Anyaman bambu', 'en' => 'Woven bamboo'], 'icon' => '🧺', 'correct' => true],
                ['label' => ['id' => 'Pelinggih', 'en' => 'Family shrine (pelinggih)'], 'icon' => '⛩️', 'correct' => true],
                ['label' => ['id' => 'Pagar beton modern', 'en' => 'Modern concrete fence'], 'icon' => '🧱', 'correct' => false],
                ['label' => ['id' => 'Antena parabola', 'en' => 'Satellite dish'], 'icon' => '📡', 'correct' => false],
                ['label' => ['id' => 'Lampu neon', 'en' => 'Neon light'], 'icon' => '💡', 'correct' => false],
                ['label' => ['id' => 'Patung beton modern', 'en' => 'Modern concrete statue'], 'icon' => '🗿', 'correct' => false],
            ],
        ]);
        ...
        $this->mission($points[2], 2, 'matching', ['id' => 'Heritage Explorer: Cocokkan Objeknya', 'en' => 'Heritage Explorer: Match the Objects'], [
            ...
            'pairs' => [
                ['left' => ['id' => 'Angkul-angkul', 'en' => 'Angkul-angkul'], 'right' => ['id' => 'Gerbang masuk khas di depan setiap rumah', 'en' => 'The distinctive entrance gate of every house'], 'icon' => '🚪'],
                ['left' => ['id' => 'Loloh Cemcem', 'en' => 'Loloh Cemcem'], 'right' => ['id' => 'Minuman herbal tradisional dari daun cemcem', 'en' => 'Traditional herbal drink from cemcem leaves'], 'icon' => '🌿'],
                ['left' => ['id' => 'Anyaman bambu', 'en' => 'Woven bamboo'], 'right' => ['id' => 'Kerajinan tangan warga dari bambu hutan adat', 'en' => 'Handicraft made from customary forest bamboo'], 'icon' => '🧺'],
                ['left' => ['id' => 'Pelinggih', 'en' => 'Pelinggih'], 'right' => ['id' => 'Bangunan suci kecil untuk persembahyangan keluarga', 'en' => 'Small shrine for family worship'], 'icon' => '⛩️'],
            ],
        ]);
        ...
        $this->mission($points[3], 1, 'matching', ['id' => 'Sacred Puzzle: Tata Letak Merajan', 'en' => 'Sacred Puzzle: The Merajan Layout'], [
            ...
            'pairs' => [
                ['left' => ['id' => 'Sanggah Kemulan', 'en' => 'Sanggah Kemulan'], 'right' => ['id' => 'Pemujaan roh leluhur keluarga (rong tiga)', 'en' => 'Worship of family ancestors (three chambers)'], 'icon' => '🛕'],
                ['left' => ['id' => 'Padmasana', 'en' => 'Padmasana'], 'right' => ['id' => 'Pemujaan Ida Sang Hyang Widhi Wasa', 'en' => 'Worship of Ida Sang Hyang Widhi Wasa'], 'icon' => '⛩️'],
                ['left' => ['id' => 'Piyasan', 'en' => 'Piyasan'], 'right' => ['id' => 'Tempat menata sesajen dan sarana upacara', 'en' => 'Place to arrange offerings and ceremonial items'], 'icon' => '🪔'],
            ],
        ]);
        ...
        $this->mission($points[4], 1, 'matching', ['id' => 'Sound Detective', 'en' => 'Sound Detective'], [
            ...
            'pairs' => [
                ['left' => ['id' => '🔊 Bunyi cepat bertalu-talu', 'en' => '🔊 Fast, insistent beats'], 'right' => ['id' => 'Tanda bahaya / keadaan darurat', 'en' => 'Danger / emergency alert'], 'audio' => null],
                ['left' => ['id' => '🔉 Bunyi lambat berirama', 'en' => '🔉 Slow, rhythmic beats'], 'right' => ['id' => 'Panggilan rapat dan gotong royong warga', 'en' => 'Call for village meetings and communal work'], 'audio' => null],
                ['left' => ['id' => '🔈 Bunyi sedang teratur', 'en' => '🔈 Steady, moderate beats'], 'right' => ['id' => 'Penanda upacara adat dimulai', 'en' => 'Signal that a ceremony is starting'], 'audio' => null],
            ],
        ]);
