...
class Route1HeritageQuestSeeder extends Seeder
{
    ...
    private function rebuildMissions(array $points): void
    {
        ...
        $this->mission($points[2], 1, 'matching', ['id' => 'Heritage Explorer: Temukan Objeknya', 'en' => 'Heritage Explorer: Find the Objects'], [
            ...
            'pick_count' => 4,
            'items' => [
                ['label' => ['id' => 'Angkul-angkul', 'en' => 'Angkul-angkul'], 'icon' => '🚪', 'correct' => true, 'explanation' => ['id' => 'Angkul-angkul adalah gerbang khas di depan setiap rumah Penglipuran.', 'en' => 'Angkul-angkul are the distinctive gates in front of every Penglipuran house.']],
                ['label' => ['id' => 'Tanaman Loloh Cemcem', 'en' => 'Loloh Cemcem plant'], 'icon' => '🌿', 'correct' => true, 'explanation' => ['id' => 'Daun cemcem digunakan untuk minuman herbal penyegar khas desa.', 'en' => 'Cemcem leaves are used for the village’s signature refreshing herbal drink.']],
                ['label' => ['id' => 'Anyaman bambu', 'en' => 'Woven bamboo'], 'icon' => '🧺', 'correct' => true, 'explanation' => ['id' => 'Anyaman bambu adalah kerajinan tangan warga dari hutan adat.', 'en' => 'Woven bamboo is a handicraft made by residents from the customary forest.']],
                ['label' => ['id' => 'Pelinggih', 'en' => 'Family shrine (pelinggih)'], 'icon' => '⛩️', 'correct' => true, 'explanation' => ['id' => 'Pelinggih adalah bangunan suci kecil untuk persembahyangan keluarga.', 'en' => 'Pelinggih is a small shrine for family worship.']],
                ['label' => ['id' => 'Pagar beton modern', 'en' => 'Modern concrete fence'], 'icon' => '🧱', 'correct' => false, 'explanation' => ['id' => 'Pagar beton modern bukan bagian dari arsitektur tradisional Penglipuran.', 'en' => 'Modern concrete fences are not part of traditional Penglipuran architecture.']],
                ['label' => ['id' => 'Antena parabola', 'en' => 'Satellite dish'], 'icon' => '📡', 'correct' => false, 'explanation' => ['id' => 'Antena parabola adalah teknologi modern yang tidak menjadi ciri khas desa adat.', 'en' => 'Satellite dishes are modern technology, not a feature of the traditional village.']],
                ['label' => ['id' => 'Lampu neon', 'en' => 'Neon light'], 'icon' => '💡', 'correct' => false, 'explanation' => ['id' => 'Lampu neon tidak termasuk elemen tradisional tata ruang desa.', 'en' => 'Neon lights are not a traditional element of the village layout.']],
                ['label' => ['id' => 'Patung beton modern', 'en' => 'Modern concrete statue'], 'icon' => '🗿', 'correct' => false, 'explanation' => ['id' => 'Patung beton modern bukan bagian dari penataan tradisional Penglipuran.', 'en' => 'Modern concrete statues are not part of Penglipuran’s traditional arrangement.']],
            ],
        ]);
        ...
        $this->mission($points[2], 2, 'matching', ['id' => 'Heritage Explorer: Cocokkan Objeknya', 'en' => 'Heritage Explorer: Match the Objects'], [
            ...
            'pairs' => [
                ['left' => ['id' => 'Angkul-angkul', 'en' => 'Angkul-angkul'], 'right' => ['id' => 'Gerbang masuk khas di depan setiap rumah', 'en' => 'The distinctive entrance gate of every house'], 'icon' => '🚪', 'explanation' => ['id' => 'Angkul-angkul menandai batas antara ruang publik dan privat rumah tradisional.', 'en' => 'Angkul-angkul marks the boundary between public and private space in a traditional house.']],
                ['left' => ['id' => 'Loloh Cemcem', 'en' => 'Loloh Cemcem'], 'right' => ['id' => 'Minuman herbal tradisional dari daun cemcem', 'en' => 'Traditional herbal drink from cemcem leaves'], 'icon' => '🌿', 'explanation' => ['id' => 'Loloh Cemcem adalah minuman khas yang menyegarkan dan menjadi warisan kuliner desa.', 'en' => 'Loloh Cemcem is a signature refreshing drink and part of the village’s culinary heritage.']],
                ['left' => ['id' => 'Anyaman bambu', 'en' => 'Woven bamboo'], 'right' => ['id' => 'Kerajinan tangan warga dari bambu hutan adat', 'en' => 'Handicraft made from customary forest bamboo'], 'icon' => '🧺', 'explanation' => ['id' => 'Anyaman bambu menunjukkan pemanfaatan hutan adat secara lestari.', 'en' => 'Woven bamboo shows the sustainable use of the customary forest.']],
                ['left' => ['id' => 'Pelinggih', 'en' => 'Pelinggih'], 'right' => ['id' => 'Bangunan suci kecil untuk persembahyangan keluarga', 'en' => 'Small shrine for family worship'], 'icon' => '⛩️', 'explanation' => ['id' => 'Pelinggih mengingatkan pentingnya spiritualitas dan hubungan dengan leluhur.', 'en' => 'Pelinggih reminds us of spirituality and the connection with ancestors.']],
            ],
        ]);
        ...
        $this->mission($points[3], 1, 'matching', ['id' => 'Sacred Puzzle: Tata Letak Merajan', 'en' => 'Sacred Puzzle: The Merajan Layout'], [
            ...
            'pairs' => [
                ['left' => ['id' => 'Sanggah Kemulan', 'en' => 'Sanggah Kemulan'], 'right' => ['id' => 'Pemujaan roh leluhur keluarga (rong tiga)', 'en' => 'Worship of family ancestors (three chambers)'], 'icon' => '🛕', 'explanation' => ['id' => 'Sanggah Kemulan menjadi pusat pemujaan leluhur dalam kompleks rumah Bali.', 'en' => 'Sanggah Kemulan is the center of ancestor worship within a Balinese house compound.']],
                ['left' => ['id' => 'Padmasana', 'en' => 'Padmasana'], 'right' => ['id' => 'Pemujaan Ida Sang Hyang Widhi Wasa', 'en' => 'Worship of Ida Sang Hyang Widhi Wasa'], 'icon' => '⛩️', 'explanation' => ['id' => 'Padmasana melambangkan kesucian tertinggi dan hubungan manusia dengan Sang Pencipta.', 'en' => 'Padmasana symbolizes the highest sanctity and the human connection to the Creator.']],
                ['left' => ['id' => 'Piyasan', 'en' => 'Piyasan'], 'right' => ['id' => 'Tempat menata sesajen dan sarana upacara', 'en' => 'Place to arrange offerings and ceremonial items'], 'icon' => '🪔', 'explanation' => ['id' => 'Piyasan berfungsi menyiapkan persembahan sebelum upacara keluarga atau desa.', 'en' => 'Piyasan is used to prepare offerings before family or village ceremonies.']],
            ],
        ]);
